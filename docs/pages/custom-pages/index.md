...
Then, add nav in your `saber-config.js`:
...
Add you custom layout in `layouts/CustomLayout.vue`:
...
<template>
  <div class="custom-layout">
    ...
    <div class="main-div">
      <!-- <slot /> is to show the rendered markdown content of this page -->
      <slot />
    </div>
  </div>
</template>
...
Contents here will be rendered in the `<slot />` component.
```
