...
export default {
  ...
  computed: {
    meta () {
      return this.$attributes['meta'] !== false
    },

    vssue () {
      return this.$themeConfig.comments !== false && this.$attributes['vssue'] !== false && (this.vssueTitle || this.vssueId)
    },

    vssueTitle () {
      return this.$attributes['vssue-title'] || this.$attributes['title'] || undefined
    },

    vssueId () {
      return this.$attributes['vssue-id'] || undefined
    },
